...
+(int)decimals:(double)number
{
    ...
    double i = [ChartUtils roundToNextSignificant:number];
    if (isnan(i) || isinf(i)) {
        return 0;
    }
...
+(CGSize)sizeOfRotatedRectangle:(CGFloat)rectangleWidth rectangleHeight:(CGFloat)rectangleHeight radians:(CGFloat)radians
{
